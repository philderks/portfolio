...
A [Next.js](https://nextjs.org) portfolio site with [Tailwind CSS](https://tailwindcss.com), bootstrapped with [`create-next-app`](https://nextjs.org/docs/app/api-reference/cli/create-next-app).

## Getting Started

### Option 1: Dev Container (recommended)

This project includes a [dev container](https://containers.dev) configuration for a consistent development environment with all dependencies pre-installed.
...
- [Dev Containers Documentation](https://containers.dev) — learn about dev containers.
